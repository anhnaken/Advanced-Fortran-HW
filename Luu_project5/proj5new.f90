...
! - - - - - - - - - - - - !	
  ...
  allocate( F(1:n) )												! derivatives 
 	...
 	open(unit=10,file="onemass2.dat",status="unknown")
 	open(unit=11,file="twomass2.dat",status="unknown")
 	open(unit=12,file="energycons2.dat",status="unknown")
 	open(unit=13,file="angmoment2.dat",status="unknown")
